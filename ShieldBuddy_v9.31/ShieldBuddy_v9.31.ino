...
SoftwareWire tick_ctrl(21, 20, true, false);
...
{
  tick_ctrl.beginTransmission(COMP_DAC);
  tick_ctrl.write((output_number - 1) * 2);
  tick_ctrl.write(highByte(dutyCycleToAnalog(duty_cycle)));
  tick_ctrl.write(lowByte(dutyCycleToAnalog(duty_cycle)));
  tick_ctrl.endTransmission(false);
...
//  Wire3.endTransmission(false);
  switch(output_number)
  {
    case 1:
      ...
      tick_ctrl.beginTransmission(MCP1);
      tick_ctrl.write(wiper0);
      tick_ctrl.write(amplitudeToAnalog(tickle_amplitude));
      tick_ctrl.endTransmission(false);
      break;
  }
}
...
{
  tick_ctrl.beginTransmission(72);
  tick_ctrl.write(48);
  tick_ctrl.write(1);
  tick_ctrl.write(1);
  tick_ctrl.endTransmission(false);
